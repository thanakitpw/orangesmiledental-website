...
import type { Service, Step } from '@/content/services';
import type { ServicePerk } from '@/lib/site-content';
...
export function ServicesView({ services, perks, steps }: ServicesViewData) {
