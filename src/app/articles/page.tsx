...
export default function ArticlesPage() {
  ...
  const shown = cat === 'all' ? ARTICLES : ARTICLES.filter((p) => p.cat === cat);
        ...
        >
          <div data-reveal="" style={{ textAlign: 'center', maxWidth: 760, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 17.5, color: 'rgba(61,53,46,.64)', margin: '18px 0 0' }}>
              {t(
                'เคล็ดลับดูแลสุขภาพช่องปากและความรู้เรื่องทันตกรรม เขียนโดยทีมทันตแพทย์ของเราเอง',
                'Oral-health tips and dentistry know-how, written by our own dental team.',
              )}
            </p>
          </div>
        </div>
            ...
            >
              ...
              >
                ...
                <span style={{ color: 'rgba(61,53,46,.5)' }}>
                  {tl(FEATURED.date)} · {tl(FEATURED.read)}
                </span>
              </div>
              <h2
                style={{
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={mediaUrl(FEATURED.authorImg)}
                  alt={tl(FEATURED.author)}
                  style={{
                    width: 40,
                    height: 40,
                    borderRadius: '50%',
